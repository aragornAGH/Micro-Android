...
public class DataSource implements Serializable {
    ...
    private double calcCharge(int chargeId) {
        ...
        switch (chargeId) {
            case CHARGE_SENSOR:
                return bst.getCharge();
            case CHARGE_FULL:
                return bst.getFullCapacity();
            case CHARGE_1400:
                return 1400 * 3.6; // mAh -> As
        }
        return -1.0;
    }
}
